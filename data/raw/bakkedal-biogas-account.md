...
- Customer number in SAP: 100731
- Account manager: Line Toft
- Technical contact: Peter Storm, Plant Manager
- Installed base: two PL-400 pump lines, commissioned 2022, both with variable frequency drives

## Notes

Peter Storm reported the same symptom pattern as Nordvind: intermittent vibration alarms on a
